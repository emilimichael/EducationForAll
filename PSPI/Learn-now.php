    ...
    <section class="cards-area">
      <section class="cards-area" id="kids-section">
        ...
        <div class="cards-area-container">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h2> <span class='top-numbers'> 1 </span>
                <a class="card-link" href="https://www.funbrain.com" target="_blank">funbrain.com</a>
              </h2>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <h2><span class='top-numbers'> 2 </span>
                <a class="card-link" href="https://www.starfall.com/" target="_blank">starfall.com</a>
              </h2>
          ...
          <div class="card">
            <div class="card-header">
              <img src="./images/kids3.jpg" alt="book_pic">
            </div>
            <div class="card-body">
              <h2> <span class='top-numbers'> 3 </span>
                <a class="card-link" href="https://www.coolmath4kids.com/" target="_blank">www.coolmath4kids.com</a>
              </h2>
      ...
      <section class="cards-area" id="teenagers-section">
        ...
        <div class="cards-area-container">
          ...
          <div class="card">
            <div class="card-header">
              <img src="./images/teenager1.jpg" alt="book_pic">
            </div>
            <div class="card-body">
              <h2> <span class='top-numbers'> 1 </span>
                <a class="card-link" href="https://www.khanacademy.org/" target="_blank">www.khanacademy.org</a>
              </h2>
          ...
          <div class="card">
            <div class="card-header">
              <img src="./images/teenager2.jpg" alt="book_pic">
            </div>
            <div class="card-body">
              <h2> <span class='top-numbers'> 2 </span>
                <a class="card-link" href="https://www.hippocampus.org/" target="_blank">www.hippocampus.org</a>
              </h2>
          ...
          <div class="card">
            <div class="card-header">
              <img src="./images/teenager3.jpg" alt="book_pic">
            </div>
            <div class="card-body">
              <h2> <span class='top-numbers'> 3 </span>
                <a class="card-link" href="https://www.ck12.org/student/" target="_blank">www.ck12.org</a>
              </h2>
      ...
      <section class="cards-area" id="adults-section">
        ...
        <div class="cards-area-container">
          ...
          <div class="card">
            <div class="card-header">
              <img src="./images/adult1.jpg" alt="Adult">
            </div>
            <div class="card-body">
              <h2> <span class='top-numbers'> 1 </span>
                <a class="card-link" href="https://www.coursera.org/" target="_blank">www.coursera.org</a>
              </h2>
              <p><b>Coursera</b> Inc. is an American massive open online course provider founded in 2012 by Stanford University computer science professors Andrew Ng and Daphne Koller.
                ...
                <span class="source-font"><b>Source:</b><a href="https://en.wikipedia.org/wiki/Coursera" target="_blank"> https://en.wikipedia.org/wiki/Coursera</a></span>
              </p>
            </div>
            <div class="card-footer">
          ...
          <div class="card">
            <div class="card-header">
              <img src="./images/adult2.jpg" alt="book_pic">
            </div>
            <div class="card-body">
              <h2> <span class='top-numbers'> 2 </span>
                <a class="card-link" href="https://www.udemy.com/" target="_blank">www.udemy.com</a>
              </h2>
              <p>
          ...
          <div class="card">
            <div class="card-header">
              <img src="./images/adult3.jpg" alt="book_pic">
            </div>
            <div class="card-body">
              <h2> <span class='top-numbers'> 3 </span>
                <a class="card-link" href="https://www.edx.org/" target="_blank">www.edx.org</a>
              </h2>
